...
const transactionModel = require("./otherTransaction.model");
const userModel = require("../User/user.model");


class OtherTransactionController {
    ...
    static async getTotalIncomeExpense(req, res) {
...
module.exports = OtherTransactionController