...
const transactionCategoryModal = require('./otherTransactionCategory.model');
const userModel = require('../User/user.model');


class OtherTransactionCategoryController {
...
module.exports = OtherTransactionCategoryController