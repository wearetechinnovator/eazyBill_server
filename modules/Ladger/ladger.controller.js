...
class LadgerController {
    // Voucher enum wise model pair;
    static voucherModels = {
        'sales': 'salesinvoice',
    ...
    // ==============================================
    static async addLadger({ token, partyId, voucher, voucherId, credit, debit, date }) {
        try {
            ...
            const insert = await ladgerModel.create({
                ...
                voucherModel: LadgerController.voucherModels[voucher]
            })
    ...
    static async updateLadger({ partyId, voucher, voucherId, credit, debit, date }) {
        try {
    ...
    static async get(req, res) {
        const { token, partyId, startDate, endDate } = req.body;
    ...
    static async getPartyBalance(req, res) {
    ...
    static async getAllPartyBalance(req, res) {
...
module.exports = LadgerController;