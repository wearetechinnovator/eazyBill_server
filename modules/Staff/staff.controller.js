...
const attendanceSettingModel = require("../Attendance/attendanceSetting.model");
...
class StaffController {
    ...
    static async addAttendanceSetting(req, res) {
        const {
    ...
    static async getAttendanceSetting(req, res) {
