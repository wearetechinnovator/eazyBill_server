...
const transactionCategoryModal = require('../OtherTransactionCategory/otherTransactionCategory.model');
const staffPaymentModel = require("./staffPayment.model");
const staffMonthlyPaymentModel = require("./staffMonthlyPayment.model");


class StaffPaymentController {
    // CONSTANTS;
    static STAFF_SALARY_TRANSACTION_CATEGORY = "Employee Salary & Advance";
    static EXPENSE = "expense";
    static LOAN = "loan";
    static LOAN_RECEIVED = 'loan_received';
    ...
    static async getTotalLoan(req, res) {
    ...
    static async getTotalDues(req, res) {
    ...
    static async getLastMonthPayment(req, res) {
        const { token, currentMonth, currentYear, staffId } = req.body;
...
module.exports = StaffPaymentController