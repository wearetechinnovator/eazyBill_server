...
const { addLadger, updateLadger } = require("../Ladger/ladger.model");
...
const paymentInModel = require("./paymentIn.model");
...
class PaymentInController {
    ...
    static async getMonthWisePaymentIn(req, res) {
        const { token } = req.body;
    ...
    static async getCashIn(req, res) {
        const { token } = req.body;
...
module.exports = PaymentInController